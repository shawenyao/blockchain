    ...
    def utxo(chain):
        ...
        for block in chain:
            for transaction in block['block']['transactions']:
                ...
                # for recipient:
                balances[transaction['recipient']] = balances.get(transaction['recipient'], default=0) + transaction['amount']
                # for sender:
                balances[transaction['sender']] = balances.get(transaction['sender'], default=0) - transaction['amount']
